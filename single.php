      ...
      <?php while ( have_rows('content') ) : the_row(); ?>
        ...
        <?php if ($i == 0):?>
          ...
          <?php if(get_sub_field('media_type') == 'Image'):?>
            ...
            <img src="<?php echo $image['sizes']['pwr-large']; ?>" data-caption="<?php echo the_sub_field('caption'); ?>" data-extended='<?php echo the_sub_field('extended_caption'); ?>' data-pdf='<?php echo $pdf['url'];?>' class='slide shown <?php if(get_sub_field("full_screen")):?>full-screen<?php endif;?>'>
...
<!--              </div>-->
        ...
        <?php else: ?>
          ...
          <?php if(get_sub_field('media_type') == 'Image'):?>
            ...
            <img src="<?php echo $image['sizes']['pwr-large']; ?>" data-caption="<?php echo the_sub_field('caption'); ?>" data-extended='<?php echo the_sub_field('extended_caption'); ?>' data-pdf='<?php echo $pdf['url'];?>' class='slide <?php if(get_sub_field("full_screen")):?>full-screen<?php endif;?>'>
